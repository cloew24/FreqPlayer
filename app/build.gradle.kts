...
android {
    ...
    buildTypes {
        ...
        debug {
            // Debug always builds without R8 — keeps iteration fast and
            // ensures the debug APK matches what we've been testing.
...
dependencies {
    ...
    // DocumentFile for walking SAF-picked folder trees (Open Folder feature).
